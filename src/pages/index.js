        ...
        let affichage = `<img class=arrow-return src="./assets/images/retour.png" >
                        <div class=container-rules>
                            ...
                            <div class=recap-rules>
                                ...
                                <p>Lors de chaque tour durant la partie, chacun des joueurs devra dire un mot se rapprochant du sien (sans dire le sien). </p>
                                ...
                                <p>Chaque joueur ne connait que son mot et pas son rôle, ne soyez pas trop précis dans les mots que vous choisissez, au risque que cela se retourne contre vous ... </p>
                                <p>Pour rajouter un peu de piments au jeu, vous pouvez choisir de jouer avec Mr White également. </p>
                                <p>Son rôle est comme celui de l'imposteur, ne pas se faire démasquer, au détail près que l'imposteur n'a PAS DE MOT attribué lors du début de partie. </p>
                            </div>
                        </div>`
